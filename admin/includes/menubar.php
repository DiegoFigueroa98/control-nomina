<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><b>INICIO</b></li>
        <li class=""><a href="home.php"><i class="fa fa-dashboard"></i> <span>Menú principal</span></a></li>
        <li class="header"><b>ADMINISTRACIÓN</b></li>
        ...
        <li class="header"><b>REPORTES</b></li>
